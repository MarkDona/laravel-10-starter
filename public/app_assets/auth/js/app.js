/******/ (function(modules) { // webpackBootstrap
    ...
    /******/ ({
        ...
        /***/ (function(module, exports) {
            ...
            (function (window, document, $) {
                ...
                $(window).on("load", function () {
                    ...
                    $('a[data-action="reload"]').on("click", function () {
                        ...
                        if ($body.hasClass("dark-layout")) {
                            var _reloadActionOverlay = "#10163a";
                        } else {
                            var _reloadActionOverlay2 = "#fff";
                        } // Block Element
                ...
                $(".dropdown-language .dropdown-item").on("click", function () {
                    ...
                    $("#dropdown-flag .flag-icon").removeClass().addClass(selectedFlag); // let currentLanguage = $this.data("language");
                ...
                if ($('.search-list-main').length) {
                    var _searchListMain = new PerfectScrollbar(".search-list-main", {
                        wheelPropagation: false
                    });
                }
                            ...
                            $.getJSON("data/" + $filename + ".json", function (data) {
                                for (var i = 0; i < data.listItems.length; i++) {
                                    ...
                                    if (data.listItems[i].name.toLowerCase().indexOf(value) == 0 && a < 5) {
                                        if (a === 0) {
                                            _$activeItemClass = "current_item";
                                        } else {
                                            _$activeItemClass = "";
                                        }

                                        $startList += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' + _$activeItemClass + '">' + '<a class="d-flex align-items-center justify-content-between w-100" href=' + data.listItems[i].url + ">" + '<div class="d-flex justify-content-start align-items-center">' + '<span class="mr-75 ' + data.listItems[i].icon + '" data-icon="' + data.listItems[i].icon + '"></span>' + "<span>" + data.listItems[i].name + "</span>" + "</div>" + $bookmarkIcon + "</a>" + "</li>";
                                        a++;
                                    }
                                }

                                for (var _i = 0; _i < data.listItems.length; _i++) {
                                    if (bookmark === true) {
                                        activeClass = ""; // resetting active bookmark class

                                        var _arrList = $("ul.nav.navbar-nav.bookmark-icons li"),
                                            _$arrList = ""; // Loop to check if current seach value match with the bookmarks already there in navbar


                                        for (var _j = 0; _j < _arrList.length; _j++) {
                                            if (data.listItems[_i].name === _arrList[_j].firstChild.dataset.originalTitle) {
                                                activeClass = " warning";
                                            } else {
                                                activeClass = "";
                                            }
                                    ...
                                    if (!(data.listItems[_i].name.toLowerCase().indexOf(value) == 0) && data.listItems[_i].name.toLowerCase().indexOf(value) > -1 && a < 5) {
                                        if (a === 0) {
                                            _$activeItemClass = "current_item";
                                        } else {
                                            _$activeItemClass = "";
                                        ...
                                        $otherList += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' + _$activeItemClass + '">' + '<a class="d-flex align-items-center justify-content-between w-100" href=' + data.listItems[_i].url + ">" + '<div class="d-flex justify-content-start align-items-center">' + '<span class="mr-75 ' + data.listItems[_i].icon + '" data-icon="' + data.listItems[_i].icon + '"></span>' + "<span>" + data.listItems[_i].name + "</span>" + "</div>" + $bookmarkIcon + "</a>" + "</li>";
                                        a++;
                                    }
                                }
                ...
                $(document).on("click", ".bookmark-input .search-list .bookmark-icon", function (e) {
                    ...
                    if ($(this).hasClass("warning")) {
                        ...
                        var _arrList2 = $("ul.nav.navbar-nav.bookmark-icons li");
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            module.exports = __webpack_require__(/*! /opt/lampp/htdocs/codes/usmsghapp_v3/resources/js/core/app.js */"./resources/js/core/app.js");
